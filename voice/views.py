...
class SaveVoiceView(APIView):
    ...
    def post(self, request):
        ...
        if audio_file:
            ...
            send_audio('media/'+file_name, voice.sentence.body, voice.sentence.id, group_id=1)
            ...
            return Response({"error": "Audio fayli topilmadi"}, status=status.HTTP_400_BAD_REQUEST)
